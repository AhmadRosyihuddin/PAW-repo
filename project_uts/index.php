		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center pesan">
					...
					<div>
						<a href="proses_login/login.php" class="button">
							<button>Pesan</button>
						</a>
					</div>
				</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 d-flex align-items-stretch">
						<div class="member">
							<div class="member-img">
								<img src="assets/img/menu/menu1.png" class="img-fluid" alt="" />
							</div>
					...
					<div class="col-lg-3 col-md-6 d-flex align-items-stretch">
						<div class="member">
							<div class="member-img">
								<img src="assets/img/menu/menu2.png" class="img-fluid" alt="" />
							</div>
					...
					<div class="col-lg-3 col-md-6 d-flex align-items-stretch">
						<div class="member">
							<div class="member-img">
								<img src="assets/img/menu/menu3.png" class="img-fluid" alt="" />
							</div>
							<div class="member-info">
								<h4>Chili Rose</h4>
								<span>Rp. 25.000</span>
					...
					<div class="col-lg-3 col-md-6 d-flex align-items-stretch">
						<div class="member">
							<div class="member-img">
								<img src="assets/img/menu/menu4.png" class="img-fluid" alt="" />
							</div>
							<div class="member-info">
								<h4>Ayam Prostos</h4>
								<span>Rp. 35.000</span>
